...
# Add design files
add_files psx_enable.cpp

# Set the top-level function
set_top psx_enable

# Add testbench & golden output files
add_files -tb "psx_enable_tb.cpp out_gold.dat" 
...
if {$VIVADO_SYN == 1} {
  ...
  export_design -format ip_catalog -rtl vhdl -display_name "pr7hp_enable" -flow syn
}

# Export RTL & Vivado Logic Synthesis, Place and Route
if {$VIVADO_IMPL == 1} {
  # Add -trace_level port to generate .wdb file
  export_design -format ip_catalog -rtl vhdl -display_name "pr7hp_enable" -flow impl
}
